...
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------ |
| 1   | **`CRON_SECRET` set, and Vercel Cron confirmed running.** Since ADR 0019 settlement does not use a callback: the return page settles while the buyer watches, and a five-minute sweep catches everyone else. The cron is a settlement path, not housekeeping | Anyone who closes the tab after paying never gets their ticket, and their seats stay reserved    |
