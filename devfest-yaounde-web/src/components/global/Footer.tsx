...
const LINK_CLASS =
  "link-item inline-block text-body-l text-offwhite/85 transition-colors duration-200 hover:text-yellow";
        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-[1.1fr_1fr] lg:gap-20">
          <Reveal>
            <div>
              ...
              <p className="mt-7 font-sans text-display-hero font-bold leading-[0.86] tracking-tight text-offwhite">
                DevFest
                <span className="block text-yellow">Yaoundé</span>
              </p>
            </div>
          </Reveal>
